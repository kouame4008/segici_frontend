            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-10" style="position : relative; top : -20px">
                        <label for="">Rechercher un bien</label>
                        <a-input v-model:value="rechercherBien" placeholder="Rechercher un bien" size="large" @search="onSearch" allow-clear @change="handleSearch" />
                    </div>
                </div>
                <div class="row mt-2">
