            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-12">
                    <div class="text-left breadcrumb-wrapper">
                        <h2>Recherchez des résidences meublées </h2>
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="m-0 form-group">
                                                        <div class="input-group">
                                                            <strong class="text-white"> <span for="">Nom de la résidence</span></strong>
...
export default {
    ...
    setup() {
        ...
        const handleListeResidence = () => {
            let etablissement_id = 2;
